...
export const listGate = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const addGateway = async (req: Request, res: Response) => {
  try {
    ...
    const result = await model.addGateway(
      gatewayID,
      gateway_name,
      gateway_addrs,
      gateway_MQID,
...
export const delBeac = async (req: Request, res: Response) => {
  try {
