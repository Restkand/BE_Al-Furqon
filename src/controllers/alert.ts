...
export const listAlibi = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const insertAlibi = async (req: Request, res: Response) => {
  try {
...
export const updateAlibi = async (req: Request, res: Response) => {
  try {
...
export const deleteAlibi = async (req: Request, res: Response) => {
  try {
...
export const insertAlertType = async (req: Request, res: Response) => {
  try {
...
export const updateAlertType = async (req: Request, res: Response) => {
  try {
...
export const deleteAlertType = async (req: Request, res: Response) => {
  try {
...
export const listAlert = async (req: Request, res: Response) => {
  try {
    const list = await model.listAlert();
...
export const insertAlert = async (req: Request, res: Response) => {
  try {
    const {
      gateway,
      track,
    ...
    const result = await model.insertAlert(
      gateway,
      track,
      employee,
      vendor,
...
export const statusAlert = async (req: Request, res: Response) => {
  try {
    const list = await model.listStatusAlert();
    res.status(200).json(list);
  } catch (error: any) {
    console.error("Insert failed:", error);
    res.status(500).json({
