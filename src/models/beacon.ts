...
export const insertBeacon = async (
  beaconCode: string,
  site: string,
  name: string,
  beaconMacAddr: string,
  beaconBattery: any,
  BeaconBatteryCreat: string,
  created_by: string,
  updated_by: string
) => {
  try {
    return await prisma.ms_beacon.create({
      data: {
...
export const updateBeacon = async (
  ...
  try {
    ...
    return await prisma.ms_beacon.update({
      where: { id: idAsNumber },
      data: {
        siteid: site,
        beacon_name: name,
...
export const deleteBeacon = async (updated_by: string, id: string) => {
  try {
    const idAsNumber = Number(id);
    return await prisma.ms_beacon.update({
      where: {
